...
def saveContent(fileList, owner: str, manifest: str, challenge: str, solution: str) -> bool:
    ...
    _ = cursor.execute("INSERT INTO proofs VALUES(?,?,?)",(file['resource'],challenge,solution))
    con.commit()
    return True 